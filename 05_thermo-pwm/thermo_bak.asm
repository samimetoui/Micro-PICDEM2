...
;en dessous de la consigne. fréquence de l'oscilateur à 4MHz
;************************************************************************
...
start
	...
	movlw 	0x3F			;PWM period =  31.2 kHz PWM ***********
	movwf 	PR2				;
...
sw1
	...
	bsf		MTR				;mofifie la vitesse du moteur
